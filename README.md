...
The main, optimized, and minimal version of the code is in the strategy.py file, while the complete version — including analysis, plots, and tests — is available in the notebook.
